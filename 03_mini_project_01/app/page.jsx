  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto m-8">
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Non sunt
          voluptate placeat tenetur commodi maiores in molestias corporis minus
          eum! Deleniti laudantium animi assumenda doloribus quos cum provident
          quis quibusdam.
        </p>
        <div className="space-x-4">
          <button className="bg-blue-500 text-white px-3 py-3 rounded-lg hover:bg-blue-600 transition-colors font-bold cursor-pointer">
            Get Started
          </button>
