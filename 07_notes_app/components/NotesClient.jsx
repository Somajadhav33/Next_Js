...
const NotesClient = ({ initialNotes }) => {
  ...
  const createNote = async (e) => {
    ...
    try {
      ...
      console.log("Error occured while creating note", error);
      ...
      <form className="bg-white p-6 rounded-lg shadow-md" onSubmit={createNote}>
        ...
        <div className="space-y-4">
          <input
            ...
            required
            className="w-full text-gray-900 p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 "
          />
          <textarea
